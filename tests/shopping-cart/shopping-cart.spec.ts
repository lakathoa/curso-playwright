...
test('buying new products', async({page})=> {
    ...
    for(let i=0; i<=5; i++){
        ...
        await page.locator("//h5[contains(., 'Producto 1')]/ancestor::div[contains(@class, 'card-body')]//button").click()//x-path
    ...
    await page.locator("button#view-cart-btn").click()//css selector
    ...
    await page.waitForTimeout(2000) //Esto no es buena práctica
